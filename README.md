...
2. Copia la URL de **jsDelivr** del archivo:
   ```html
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/micrsSCT/Estilos_y_Scripts/css/styles-sidebar.css">
   <script src=https://cdn.jsdelivr.net/gh/micrsSCT/Estilos_y_Scripts/js/archivo.js"></script>
   ```
